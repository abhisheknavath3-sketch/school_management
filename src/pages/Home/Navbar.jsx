...
const Navbar = () => {
    ...
    useEffect(() => {
        const onScroll = () => {
            ...
            // ✅ If reached bottom → activate about
        ...
        <nav className="w-full bg-white shadow-sm border-b border-black/20 fixed top-0 z-50">
                        ...
                        <ul className="flex items-center gap-6 text-sm">
                            ...
                            <li>
                                <button
                                    ...
                                    className={`${baseStyle} ${active === "events" ? activeStyle : ""
                                        }`}
                                >
                                    Events
                                </button>
                            ...
                            <li>
                                <button
                                    ...
                                    className={`${baseStyle} ${active === "about" ? activeStyle : ""
                                        }`}
                                >
                                    About
                                </button>
            ...
            {isOpen && (
                <div className="md:hidden px-6 pb-4 space-y-4 bg-white border-t">
                    <button
                        onClick={() => scrollTo("home", "home")}
                        className={`block ${active === "home" ? "text-blue-600 font-semibold" : "text-gray-900"
                            }`}
                    >
                        Home
                    </button>
